    ...
    def _xbox_controller_listener(self, sensor, state_id, datum):
        ...
        if state_id == 'a_button':
            ...
            if abs(x) > .2 or abs(y) > .2:
                ...
                # cur_angle_r1 = self.turn_r1.getEncPosition()*(2*math.pi)/self.TICKS_PER_REV
                # cur_angle_r2 = self.turn_r2.getEncPosition()*(2*math.pi)/self.TICKS_PER_REV
                # cur_angle_l1 = self.turn_l1.getEncPosition()*(2*math.pi)/self.TICKS_PER_REV
                # cur_angle_l2 = self.turn_l2.getEncPosition()*(2*math.pi)/self.TICKS_PER_REV

                # if (abs(cur_angle_r1) > math.pi/2) and (abs(position) > (self.TICKS_PER_REV/4)) and (cur_angle_r1 * position < 0): 

                #     if cur_angle_r1 > 0:
                #         #print(cur_angle - 2*math.pi)
                #         self.turn_r1.setEncPosition(cur_angle_r1 * self.TICKS_PER_REV / (2*math.pi) - self.TICKS_PER_REV)
                ...
                # if (abs(cur_angle_r2) > math.pi/2) and (abs(position) > (self.TICKS_PER_REV/4)) and (cur_angle_r2 * position < 0): 

                #     if cur_angle_r2 > 0:
                #         #print(cur_angle - 2*math.pi)
                #         self.turn_r2.setEncPosition(cur_angle_r2 * self.TICKS_PER_REV / (2*math.pi) - self.TICKS_PER_REV)
                ...
                # if (abs(cur_angle_l1) > math.pi/2) and (abs(position) > (self.TICKS_PER_REV/4)) and (cur_angle_l1 * position < 0): 

                #     if cur_angle_l1 > 0:
                #         #print(cur_angle - 2*math.pi)
                #         self.turn_l1.setEncPosition(cur_angle_l1 * self.TICKS_PER_REV / (2*math.pi) - self.TICKS_PER_REV)
                ...
                # if (abs(cur_angle_l2) > math.pi/2) and (abs(position) > (self.TICKS_PER_REV/4)) and (cur_angle_l2 * position < 0): 

                #     if cur_angle_l2 > 0:
                #         #print(cur_angle - 2*math.pi)
                #         self.turn_l2.setEncPosition(cur_angle_l2 * self.TICKS_PER_REV / (2*math.pi) - self.TICKS_PER_REV)
