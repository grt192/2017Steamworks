...
from grt.macro.red_shoot_macro import RedShootMacro

class RedShootAuto(MacroSequence):
    """
    ...
    def __init__(self, swerve, shooter, intake):
        ...
        self.red_shoot_macro = RedShootMacro(swerve, shooter, intake)
        # c = Constants()
        ...
        self.macros = [self.red_shoot_macro]
