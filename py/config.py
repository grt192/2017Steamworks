...
if recording_enabled:
	...
	record_controller = RecordMacro(talon_arr)
...
new_ac = NewAckermanController(l_joystick, xbox_controller, swerve, record_macro=record_controller, playback_macro=playback_controller)
